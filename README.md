...
5. Escape the maze by the fastest possible route.
...
7. Find the quickest route out of the maze (20%)
...
Below I will briefly explain some of the helper functions i've used and why:
